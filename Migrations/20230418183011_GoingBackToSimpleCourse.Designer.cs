...
namespace Drinks_app.Migrations
{
    ...
    [Migration("20230418183011_GoingBackToSimpleCourse")]
    partial class GoingBackToSimpleCourse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CocktailRecipeIngredient", b =>
                {
                    b.Property<long>("CocktailRecipesId")
            ...
            modelBuilder.Entity("Drinks_app.Models.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Drinks_app.Models.CocktailRecipe", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CocktailRecipeIngredient", b =>
                {
                    ...
                    b.HasOne("Drinks_app.Models.Ingredient", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Drinks_app.Models.CocktailRecipe", b =>
                {
                    b.HasOne("Drinks_app.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Drinks_app.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
